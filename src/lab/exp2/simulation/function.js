window.view = {
	...
	validateRectangleInputs: function() {
		...
		if ( a !== '2')
			alert('Incorrect value of input variables(arguments). Calculating the area of a right angled triangle requires the length of the two unique sides of the right angled triangle. Try again.')
		else if ( b !== 'float' )
